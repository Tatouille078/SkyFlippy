    ...
    return (
        <div className="bg-gray-50 overflow-hidden shadow-xl hover:shadow-2xl transition-shadow duration-300 rounded-md">
            <div className="itemcard-fade p-4">
                <h2 className="text-xl exo-2-bold text-fuchsia-50">{product.productID}</h2>
            </div>
            <div className="pt-4">
                <ul className="mb-4 space-y-2">
                    <li className="flex justify-between items-center">
                        ...
                        <div 
                            className="mr-5 ubuntu-normal rounded-2xl px-2 text-amber-700"
                            style={{
                    ...
                    <li className="flex justify-between items-center">
                        ...
                        <div 
                            className="bg-pink-100 mr-5 ubuntu-normal rounded-2xl px-2 text-amber-100"
                            style={{
                    ...
                    <li className="flex justify-between items-center">
                        <span className="text-gray-600 ml-5 exo-2-normal">écart offre / demande:</span>
                        <div 
                            className="bg-pink-100 mr-5 ubuntu-normal rounded-2xl px-2 text-pink-600"
                            style={{
